...
BEGIN
    ...
    INSERT INTO control.gold_execution_log (
        pipeline_run_id, gold_table_id, records_processed,
        execution_status, start_time, end_time, error_message
    )
    VALUES (
        @PipelineRunId, @GoldTableId, @RecordsProcessed,
        @Status, GETUTCDATE(), GETUTCDATE(), @ErrorMessage
    );
